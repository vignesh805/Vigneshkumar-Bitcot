...
Usage 
1. Click + to add a new contact. 
2. Click ✏️ to edit a contact. 
3. Click 👁 to view contact details. 
4. Click 🗑 to delete a contact. 
5. Use the search bar to filter contacts by name, phone, or email.
